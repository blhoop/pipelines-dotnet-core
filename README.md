...
|---------|--------------|
| Build | [![Build status](https://pipelines-docs.visualstudio.com/docs/_apis/build/status/dotnetcore/dotnetcore)](https://blgocubs.visualstudio.com/GitHubCheck/_apis/build/status/GitHubCheck-ASP.NET Core-CI?branch=master)|
