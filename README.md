...
|---------|--------------|
| [![Build status](https://{blgocubs}.visualstudio.com/{GitHubCheck}/_apis/build/status/{GitHubCheck-ASP.NET Core-CI}?branch=master)](https://{blgocubs}.visualstudio.com/{GitHubCheck}/_build/latest?definitionId={18}&branch=master)]|
